 ...
 *
 * Forked from <a href="https://github.com/rsocket/rsocket-java/blob/master/rsocket-transport-netty/src/main/java/io/rsocket/transport/netty/server/CloseableChannel.java">CloseableChannel</a>.
 * @see io.rsocket.transport.netty.server.CloseableChannel
 *
 * @author huangjianqin
 * @date 2022/7/30
 */
